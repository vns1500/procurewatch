...
def test_single_bid_flag_above_threshold():
    ...
    from detection.rules import detect_single_bid
...
def test_rushed_timeline_flag():
    ...
    from detection.rules import detect_rushed_timeline
...
def test_risk_contributions_values_are_reasonable():
    ...
    from detection.risk_aggregator import RISK_CONTRIBUTIONS
